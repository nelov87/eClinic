namespace EClinic.Data.Seeding
{
    ...
    internal class SiteSeeder : ISeeder
    {
        public async Task SeedAsync(EClinicDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            List<SitePages> pages = new List<SitePages>();

            pages.Add(new SitePages
            {
                Title = "About Us",
                Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer neque libero, pulvinar et elementum quis, facilisis eu ante. " +
            ...
            await dbContext.SitePages.AddRangeAsync(pages);
